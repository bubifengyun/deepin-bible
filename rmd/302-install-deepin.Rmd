...
安装系统前，进入电脑的BIOS界面，选择到Configuration页面，将SATA Controller Mode选项中的Intel RST Premium，改成AHCI。修改之后，按下F10键保存，选择YES保存并退出。然后可以在通过引导进入安装系统的界面，可以正常找到固态硬盘，然后安装操作系统了。
