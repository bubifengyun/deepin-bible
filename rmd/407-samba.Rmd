...
但是，对于局域网的Deepin深度用户来讲，除了[iptux信使](https://github.com/iptux-src/iptux)（只支持Linux、Mac，号称GNU/Linux版飞鸽传书）、[飞鸽传书](http://www.feige360.com/)（最新版跨平台支持Linux）、[大蚂蚁](https://www.bigant.cn/)外，还可以安装samba 文件传输服务器。
