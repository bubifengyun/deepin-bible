...
knitr::include_graphics("images/linux-desktop-live.png")
```
...
knitr::include_graphics("images/X-architecture.png")
```

```{r xw-w, fig.show='hold', fig.cap='Wayland 架构图', echo=FALSE}
knitr::include_graphics("images/Wayland-architecture.png")
```
...
knitr::include_graphics("images/de-Cinnamon.png")
```
...
knitr::include_graphics("images/de-GNOME.png")
```
...
knitr::include_graphics("images/de-KDE.png")
```
...
knitr::include_graphics("images/de-LXDE.png")
```
