...
\end{quote}}\fi};
\node[anchor=south west] at (1cm,-\paperheight+1cm){\ifusepartintro\parbox[t][][t]{\paperwidth/2-1.5cm}{\quad\quad\thepartintro}\fi};
\node[anchor=south east] at (\paperwidth-1cm,-\paperheight+1cm){\parbox[t][][t]{\paperwidth/2-1.5cm}{
